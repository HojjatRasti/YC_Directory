...
// Source: ./sanity/lib/quareis.ts
// Variable: STARTUP_QUARY
// Query: *[_type == "startup" && defined(slug.current)] | order( _createdAt desc ) {    _id,    title,    slug,    _createdAt,    author -> {    _id, name, bio, image    },    views,    description,    category,    image}
export type STARTUP_QUARYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
